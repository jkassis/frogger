...
Ultimately your Game needs to drive a Game Engine for rendering, sound, and input processing that works in web, desktop, and mobile containers. And if you plan to build a stack, you might as well use something that supports 3D. And, ideally, it is positioned to take advantage of the future of rendering, [WebGPU](https://en.wikipedia.org/wiki/WebGPU).
